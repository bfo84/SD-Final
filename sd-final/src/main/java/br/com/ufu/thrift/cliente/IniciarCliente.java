 ...
 */
package br.com.ufu.thrift.cliente;
                ...
                try {
                    ...
                    switch (opcao) {
                        ...
                        case 14: {//DEMO   - Demonstração da Concorrência                           
                            ...
                            ThreadSimulacao t1 = new ThreadSimulacao(args[0], Integer.parseInt(args[1]), "Um");
                            ThreadSimulacao t2 = new ThreadSimulacao(args[0], Integer.parseInt(args[1]), "Dois");
                            ThreadSimulacao t3 = new ThreadSimulacao(args[0], Integer.parseInt(args[1]), "Três");
                            ThreadSimulacao t4 = new ThreadSimulacao(args[0], Integer.parseInt(args[1]), "Quatro");
                            ThreadSimulacao t5 = new ThreadSimulacao(args[0], Integer.parseInt(args[1]), "Cinco");
