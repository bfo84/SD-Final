...
public class ThreadSimulacao extends Thread {
    ...
    int porta;
    String nome;
    br.com.ufu.thrift.grafo.Handler.Client client;

    public ThreadSimulacao(String ip, int porta, String nome) throws TTransportException, TException {
        this.transport = new TSocket(ip, porta);
        this.transport.open();
        this.protocol = new TBinaryProtocol(this.transport);
        this.ip = ip;
        this.porta = porta;
        this.client = new br.com.ufu.thrift.grafo.Handler.Client(protocol);
        this.nome = nome;
    }
