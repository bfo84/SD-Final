...
public class StartServer {
	...
	public static void main(String[] args) {
		...
		try {
			...
			CopycatServer.Builder builder = CopycatServer.builder(members.get(0)).withStateMachine(() -> {
				return handler;
			}).withTransport(NettyTransport.builder().withThreads(4).build())
					.withStorage(Storage.builder().withDirectory(new File("LOG_" + args[0] + "_" + args[2]))
			...
			// falta colocar um tempo de espera para a mensagem, pra dar tempo
